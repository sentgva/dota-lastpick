...
export const COMBOS: ComboRule[] = [
  ...
  { a: 'dazzle', b: 'lifestealer', value: 4, reason: 'Grave + Weave под ближний керри' },
  ...
  { a: 'io', b: 'gyrocopter', value: 6, reason: 'Relocate + Call Down — классический ганк' },
  { a: 'io', b: 'chaos_knight', value: 5, reason: 'Tether и реген под заход иллюзиями' },
  { a: 'io', b: 'tiny', value: 5, reason: 'Relocate + Toss с ходу' },
  ...
  { a: 'pudge', b: 'clockwerk', value: 4, reason: 'Cogs фиксируют цель под Hook' },
